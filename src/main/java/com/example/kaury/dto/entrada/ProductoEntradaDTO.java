...
public class ProductoEntradaDTO {
    ...
    public ProductoEntradaDTO(String color, String description, String idc, String imageCard, String nombre, Integer stock, String talle, Double unitPrice, List<Long> categoriasIds) {
        this.color = color;
